//
//  SwpCateGoryNavigationController.m
//  SwpCateGoryDemo
//
...
/* ---------------------- Tool       ---------------------- */
#import <SwpCateGory/UIColor+SwpColor.h>                    //  Color
#import <SwpCateGory/UINavigationBar+SwpNavigationBar.h>    //  UINavigationBar
/* ---------------------- Tool       ---------------------- */
...
@interface SwpCateGoryNavigationController ()
...
@implementation SwpCateGoryNavigationController
...
+ (instancetype)navigationControllerWithRootViewController:(UIViewController *)rootViewController {
    SwpCateGoryNavigationController *swpCateGoryNavigationController = [[SwpCateGoryNavigationController alloc] initWithRootViewController:rootViewController];
    return swpCateGoryNavigationController;
}
